...
export default function MyExperiences() {
  return (
    <div id="experiences" className="flex flex-col items-center px-4 py-10 md:px-16">
  <FadeInWhenVisible> 
  ...
  <div className="grid w-full grid-cols-1 gap-8 mb-12 max-w-7xl md:grid-cols-2">
    ...
    <div className="bg-[#0A2856] rounded-xl shadow-md flex flex-col justify-center p-6 text-white">
      <RightTriggered delay={0.3}> 
        <h2 className="mb-12 text-2xl font-semibold text-center md:text-3xl font-poppins md:text-right">
          Mobile Developer
        </h2>
        <p className="text-base font-light text-center md:text-xl font-poppins md:text-right">
  ...
  <div className="grid w-full grid-cols-1 gap-7 max-w-7xl md:grid-cols-2">
    <div className="bg-[#0A2856] rounded-xl shadow-md flex flex-col justify-center p-6 text-white">
      <LeftTriggered> 
        <h2 className="mb-16 text-2xl font-semibold md:text-3xl font-poppins">
  ...
  <div className='justify-center mt-20 text-center text-white'>
    <FadeInFromBottom delay={0.1}> 
      <h2 className='text-2xl font-bold md:text-3xl font-poppins'>
        Front-End and Back-End Mobile Developer Intern 
      </h2>
    </FadeInFromBottom>

    <FadeInFromBottom delay={0.3}> 
      <p className="mt-10 text-base font-light md:text-xl font-poppins">
