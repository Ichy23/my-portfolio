...
const Hero = () => {
    return (
      <section id="home"  className="flex flex-col items-center justify-around px-12 space-y-10 text-white lg:flex-row lg:px-16 pt-28 lg:space-y-0">
        <div classname='lg:1/3 ssm:w-full'>
          <FadeInFromTop>
          <p className="mb-2 text-[45px] text-white font-extralight font-poppins">
            Hello World!
            <span className="text-[50px] font-normal"> I am</span>
          </p>
          </FadeInFromTop>
            <div className='mt-2 text-left justify-items-start '> 
             <SlideInFromLeft><h2 className="mb-2 text-[54px] font-semibold text-left text-white font-poppins leading-[19.74px] tracking-widest">Christopher</h2></SlideInFromLeft>
             <SlideInFromLeft>
              <div className="flex items-center space-x-4">
                <h2 className="text-[54px] font-semibold tracking-widest text-white font-poppins">
                  Buluran
                </h2>
                <div className="w-28 h-[2px] bg-white" />
              </div>
            </SlideInFromLeft>
             </div>
                <a href={`mailto:buluran.c.work@gmail.com?subject=${encodeURIComponent("Let's Connect")}&body=${encodeURIComponent("Hi Christopher,\nI'm interested in your work...")}`} className="block w-96 h-14 relative rounded-[10px] group transition-transform duration-200 hover:scale-105">
